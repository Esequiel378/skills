...
| [`commit-write`](./skills/commit-write/SKILL.md) | House convention for commit messages and PR titles — `type(component): summary`, the repo-invented `prefactor` type, and the squash-merge fact that a PR title becomes the permanent commit subject. Distilled from 240 real PRs. |
